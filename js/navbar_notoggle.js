...
function initNavbarFunctions() {
    ...
    const toggleBtn = document.getElementById('page-toggle'); // n'existe pas sur cette navbar (pas de switch Médecin/IADE)
    ...
    // Fonctionnalité toggle (uniquement si l'élément existe sur cette navbar)
    if (toggleBtn) {
...
function handleVersionToggleSimple() {
    ...
    if (!toggle) return; // pas de switch sur cette navbar
